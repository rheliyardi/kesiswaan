...
// 1. mysqli_query
$sql=$this->mysqli->query("SELECT * FROM siswa WHERE
nis='".$nis."'") or die ($this->CekError());
...
$this->mysqli->query("UPDATE siswa SET ".$script_update."
WHERE nis='".$nis."'") or die ($this->CekError());
// 4. tutup koneksi
$this->TutupKoneksi();
}
function hapus($nis){
// 1. Jalankan perintah delete query
$this->mysqli->query("DELETE FROM siswa WHERE
nis='$nis'");
// 2. tutup koneksi
$this->TutupKoneksi();
}
...
$sql_simpan="INSERT INTO siswa (".$kolom_nya_baru.")
